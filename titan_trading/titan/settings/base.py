"""
Base settings for TITAN Trading System.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-54ty6l=k@0c#9ij4u+y5w+%+zpe7^9n63%g@1&jz3k*$*@-5&o')
...
ASGI_APPLICATION = 'titan.asgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('DB_USER', 'whitneywalters'),
    ...
    'timescale': {
        ...
        'USER': os.getenv('TIMESCALE_USER', 'whitneywalters'),
